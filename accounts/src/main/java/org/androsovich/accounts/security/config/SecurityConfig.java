package org.androsovich.accounts.security.config;
...
import org.androsovich.accounts.security.filters.AuthenticationTokenFilter;
        ...
        return new OpenAPI().addSecurityItem(new SecurityRequirement().
                ...
                .info(new Info().title("REST API")
                        ...
                        .version("1.0").contact(new Contact().name("Ihar Androsovich")
                                .email("igor.dekster@mail.ru").url("-----"))
